...
#----------------------------Game without graphics, optimized for NEAT purposes-------------------------------

class FlappyBird_NEAT:
    ...
    def birdUpdate(self):
        ...
        upRect = pygame.Rect(self.wallx, 360 + self.gap - self.offset + 10, 88, 500)
        downRect = pygame.Rect(self.wallx, 0 - self.gap - self.offset - 10, 88, 500)
...
#----------------------------evolving a network with NEAT------------------------------------

def eval_genomes(genomes, config):
    for genome_id, genome in genomes:
        genome.fitness = 100000
        net = neat.nn.FeedForwardNetwork.create(genome, config)
        bird = FlappyBird_NEAT()
